...
module.exports = {
  ...
  update: function(req, res) {
    ...
    Match.findOne({
      ...
      Match.player1Character = req.body.player1Character ? req.body.player1Character :
        Match.player1Character;
      Match.player2Character = req.body.player2Character ? req.body.player2Character :
        Match.player2Character;
      Match.player1EndStocks = req.body.player1EndStocks ? req.body.player1EndStocks :
        Match.player1EndStocks;
      Match.player2EndStocks = req.body.player2EndStocks ? req.body.player2EndStocks :
        Match.player2EndStocks;
